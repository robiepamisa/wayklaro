          ...
          <div class="tm-bg-primary-dark tm-block tm-block-h-auto">
            ...
            <div class="row tm-edit-product-row">
              <div class="col-xl-6 col-lg-6 col-md-12">
                <form action="{{url('admin/save-edit-product')}}" method="post" enctype="multipart/form-data" class="tm-edit-product-form">
                    @csrf
                @foreach($product as $p)
                  ...
                  <div class="form-group mb-3">
                    ...
                    >
                      ...
                      <option value="1" selected>{{$p->categories->category_name}}</option>
              ...
              <div class="col-xl-6 col-lg-6 col-md-12 mx-auto mb-4">
                <div class="tm-product-img-edit mx-auto">
                  <img src="{{asset('images/products')}}/{{$p->image_path}}" alt="Product image" class="img-fluid d-block mx-auto">
                  <i
