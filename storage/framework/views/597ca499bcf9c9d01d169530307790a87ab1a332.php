...
<body id="page-top">
  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <!-- Nav Item - Tables -->
      <li class="nav-item
      <?php if($segment=='view-ticket'): ?>
      active
      <?php endif; ?>

      ">
        <a class="nav-link" href="<?php echo e(url('user/view-ticket')); ?>">
  ...
  <script src="<?php echo e(asset('assets/vendor/jquery/isotope.js')); ?>"></script>
...
<?php /**PATH C:\xampp\htdocs\project-sekido\resources\views/layouts/user_layout.blade.php ENDPATH**/ ?>